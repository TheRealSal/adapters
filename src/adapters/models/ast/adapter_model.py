...
@add_start_docstrings(
    """AST Model transformer with the option to add multiple flexible heads on top.""",
    AUDIO_SPECTROGRAM_TRANSFORMER_START_DOCSTRING,
)
class ASTAdapterModel(ModelWithFlexibleHeadsAdaptersMixin, ASTPreTrainedModel):
