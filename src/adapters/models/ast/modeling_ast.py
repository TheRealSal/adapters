...
from transformers.models.AST.modeling_AST import ASTLayer, ASTOutput, ASTSdpaSelfAttention, ASTSelfAttention

from .mixin_vit import ViTLayerAdaptersMixin, ViTOutputAdaptersMixin, ViTSelfAttentionAdaptersMixin


# Copied from transformers.models.modeling_vit.ViTSelfAttentionWithAdapters
class ASTSelfAttentionWithAdapters(ViTSelfAttentionAdaptersMixin, ASTSelfAttention):
    def forward(
...
# Copied from transformers.models.modeling_vit.ViTSdpaSelfAttentionWithAdapters
class ASTSdpaSelfAttentionWithAdapters(ViTSelfAttentionAdaptersMixin, ASTSdpaSelfAttention):
    def forward(
        self, hidden_states, head_mask: Optional[torch.Tensor] = None, output_attentions: bool = False
    ) -> Union[Tuple[torch.Tensor, torch.Tensor], Tuple[torch.Tensor]]:
        mixed_query_layer = self.query(hidden_states)
...
# Copied from transformers.models.modeling_vit.ViTOutputWithAdapters
class ASTOutputWithAdapters(ViTOutputAdaptersMixin, ASTOutput):
...
# Copied from transformers.models.modeling_vit.ViTLayerWithAdapters
class ASTLayerWithAdapters(ViTLayerAdaptersMixin, ASTLayer):
